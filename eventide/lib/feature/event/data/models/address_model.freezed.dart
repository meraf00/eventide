...
class _$AddressModelImpl extends _AddressModel {
  ...
  @override
  String toString() {
    return 'AddressModel(name: $name, address: $address, city: $city, state: $state, country: $country, zipCode: $zipCode)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, address, city, state, country, zipCode);
